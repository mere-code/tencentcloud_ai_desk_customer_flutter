  ...
  Future<V2TimCallback> markC2CMessageAsRead({
    ...
    return _retryMarkMessageAsRead(action: () {
      return TencentImSDKPlugin.v2TIMManager
        ...
        conversationID: "${TCustomerConversationViewModel.conversationC2CPrefix}$userID",
        cleanTimestamp: 0,
        cleanSequence: 0,
      );
    });
  ...
  Future<V2TimCallback> markGroupMessageAsRead({
    ...
    return _retryMarkMessageAsRead(action: () {
      return TencentImSDKPlugin.v2TIMManager
          .getConversationManager()
          .cleanConversationUnreadMessageCount(
        conversationID: "${TCustomerConversationViewModel.conversationGroupPrefix}$groupID",
        cleanTimestamp: 0,
        cleanSequence: 0,
      );
    });
