...
class _InputTextFieldState extends TIMUIKitState<TIMUIKitInputTextField> {
  ...
  final TCustomerConversationViewModel conversationModel = serviceLocator<TCustomerConversationViewModel>();
  final TCustomerSelfInfoViewModel selfModel = serviceLocator<TCustomerSelfInfoViewModel>();
  ...
  Future handleSetDraftText({String? id, ConvType? convType, String? groupID}) async {
    ...
    String conversationID = isTopic ? convID : ((convType ?? widget.conversationType) == ConvType.c2c ? "${TCustomerConversationViewModel.conversationC2CPrefix}$convID" : "${TCustomerConversationViewModel.conversationGroupPrefix}$convID");
