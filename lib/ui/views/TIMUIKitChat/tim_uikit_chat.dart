...
class _TUIChatState extends TIMUIKitState<TencentCloudCustomerMessage> {
  ...
  final TCustomerConversationViewModel conversationViewModel = serviceLocator<TCustomerConversationViewModel>();
  TIMUIKitInputTextFieldController textFieldController = TIMUIKitInputTextFieldController();
  bool isInit = false;
  final TCustomerChatGlobalModel chatGlobalModel = serviceLocator<TCustomerChatGlobalModel>();
  ...
  @override
  void didUpdateWidget(TencentCloudCustomerMessage oldWidget) {
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    return TIMUIKitChatProviderScope(
        ...
        builder: (context, model, w) {
          final TCustomerChatGlobalModel chatGlobalModel = Provider.of<TCustomerChatGlobalModel>(context, listen: true);
          ...
          final TCustomerGroupListenerModel groupListenerModel = Provider.of<TCustomerGroupListenerModel>(context, listen: true);
...
class TIMUIKitChatProviderScope extends StatelessWidget {
  ...
  final TCustomerGroupListenerModel groupListenerModel = serviceLocator<TCustomerGroupListenerModel>();
  final TUIThemeViewModel themeViewModel = serviceLocator<TUIThemeViewModel>();
  final Widget? child;
