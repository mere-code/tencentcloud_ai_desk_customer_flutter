...
class _TIMUIKItHistoryMessageListItemState extends TIMUIKitState<TIMUIKitHistoryMessageListItem> with SingleTickerProviderStateMixin {
  ...
  final TCustomerSelfInfoViewModel selfInfoModel = serviceLocator<TCustomerSelfInfoViewModel>();
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    final isDownloadWaiting = context.select<TCustomerChatGlobalModel, bool>((value) => value.isWaiting(widget.message.msgID ?? ""));
