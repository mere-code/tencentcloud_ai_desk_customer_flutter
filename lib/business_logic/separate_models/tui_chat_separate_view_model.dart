...
class TUIChatSeparateViewModel extends ChangeNotifier {
  final TCustomerFriendshipServices _friendshipServices =
      serviceLocator<TCustomerFriendshipServices>();
  ...
  final TCustomerChatModelTools tools = serviceLocator<TCustomerChatModelTools>();
